...
const _keysInResponse = ['id', 'name', 'description', 'is_active', 'createdAt'];

export class GetEventFixture {
  static keysInResponse = _keysInResponse;
}

export class CreateEventFixture {
  static keysInResponse = _keysInResponse;

  static arrangeForCreate() {
    const faker = Event.fake()
      .aEvent()
      .withName('Movie')
...
export class UpdateEventFixture {
  static keysInResponse = _keysInResponse;
...
export class ListEventsFixture {
  static arrangeIncrementedWithCreatedAt() {
    const _entities = Event.fake()
      .theEvents(4)
      .withName((i) => i + '')
